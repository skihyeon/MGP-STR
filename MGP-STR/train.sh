...
--workers 12 --scheduler --batch_size=100 --saved_path ./model_files \
--valInterval 20000 --num_iter 2000000 --lr 1 --character korean_dict_noCn.pkl \
--exp_name char_gray_base_max25 --batch_max_length 25 \
--input_channel 1 \
...
--wandb \
--saved_model /mnt/hdd1/sgh/MGP-STR/MGP-STR/model_files/char_gray_base_max25-Seed456/iter_190000.pth \
