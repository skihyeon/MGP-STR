...
nohup env OMP_NUM_THREADS=12 CUDA_VISIBLE_DEVICES=0,3  \
...
--exp_name char_gray_base_max30_extend_dict_sensitive --batch_max_length 30 \
--input_channel 1 \
...
--saved_model /mnt/hdd1/sgh/MGP-STR/MGP-STR/model_files/char_gray_base_max30_extend_dict_sensitive-Seed456/iter_95000.pth \
